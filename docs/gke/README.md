...
Falcon Integration Gateway is able to automatically discover projects and organizations it has access to. The access permissions are determined from the service account created in the *Step 2: Create new GCP Service Account*. of this guide.
