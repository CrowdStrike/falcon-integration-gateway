...
class FalconAPI():
    ...
    def init_rtr_session(self, device_id):
        return self._resources(action='RTR_InitSession', 
                               body={
                                   'device_id': device_id
                               })

    def execute_rtr_command(self, session_id, base_command, command_string):
        return self._resources(action='RTR_ExecuteCommand',
                               body = {
    ...
    def check_rtr_command_status(self, cloud_request_id, sequence_id):
        return self._resources(action='RTR_CheckCommandStatus',
                               parameters = {
    ...
    def _command(self, *args, **kwargs):
        ...
        body = response['body']
        if 'errors' in body and body['errors'] != None:
